...
def test_alt_makefile():
    builder = MakeBuilder(BuildSpec(source_file="test_src/test.cpp", build_parameters={}),
...
def test_complex_flags():
    builder = MakeBuilder(BuildSpec(source_file="test_src/test.cpp", build_parameters=dict(OPTIMIZE="-O1 -fno-inline")))
